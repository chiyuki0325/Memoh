 ...
 */
export const postModelsEnable = <ThrowOnError extends boolean = false>(options: Options<PostModelsEnableData, ThrowOnError>) => (options.client ?? client).post<PostModelsEnableResponses, PostModelsEnableErrors, ThrowOnError>({
    url: '/models/enable',
    ...options,
    headers: {
        'Content-Type': 'application/json',
